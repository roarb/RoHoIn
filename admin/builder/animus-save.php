...
<head>
    ...
    <title>Saved Animus - RoHo.in Admin Panel</title>
</head>
...
<?php if($_SESSION['user_name'] ==  'roarb'): ?>
    <paper-drawer-panel>
        ...
        <paper-header-panel main>
            <paper-toolbar class="primary">
                <paper-icon-button icon="menu" paper-drawer-toggle></paper-icon-button>
                <h1 class="full-page-title">Saved New Animus <?php echo $name ?></h1>
            ...
            <div class="info-block-tools cushion">
                <paper-material elevation="1" class="cushion">
                    <?php
                    $obj = new AllAnimusKnown;
                    $obj->saveAnimus($name, $description, $cost, $range, $aoe, $pow, $upkeep, $offensive, $specialAbility1, $specialAbility2, $offSpdMod, $offStrMod, $offMatMod, $offRatMod, $offDefMod, $offArmMod, $duration);
                    ...
                    ?>
                    <div class="center">
                        <paper-button class="md-raised md-primary md-mid link-out" data-src="/admin/builder/animus.php">Add another Animus</paper-button>
                    </div>
                </paper-material>
            </div>
        </paper-header-panel>
