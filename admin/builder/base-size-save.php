...
<?php if($core->getAdmin()): ?>
    <paper-drawer-panel>
        ...
        <paper-header-panel main>
            <paper-toolbar class="primary">
                <paper-icon-button icon="menu" paper-drawer-toggle></paper-icon-button>
                <h1 class="full-page-title">Saved Base Size <?php echo $newType ?></h1>
            ...
            <div class="horizontal layout info-block-tools cushion">
                <paper-material elevation="1" class="cushion" style="margin:auto;">
                    <?php
                    $obj = new AllBaseSizes;
                    $obj->saveBaseSize($newType);
                    ?>
                    <p>Thank you, <?php echo $newType ?> has been added.</p>
                    <paper-button raised class="full-width-button link-out" data-src="/admin/builder/base-size.php">Add Another Base Size</paper-button>
                </paper-material>
            </div>
        </paper-header-panel>
    </paper-drawer-panel>
