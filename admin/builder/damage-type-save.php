...
<head>
    ...
    $newType = $_POST['new-damage-type'];  ?>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>Saved Damage / Immunity Type - RoHo.in Admin Panel</title>
</head>
...
<?php if($_SESSION['user_name'] ==  'roarb'): ?>
    <paper-drawer-panel>
        ...
        <paper-header-panel main>
            <paper-toolbar class="primary">
                <paper-icon-button icon="menu" paper-drawer-toggle></paper-icon-button>
                <h1 class="full-page-title">Saved Damage / Immunity Type <?php echo $newType ?></h1>
            ...
            <div class="horizontal layout info-block-tools cushion">
                <paper-material elevation="1" class="cushion" style="margin:auto;">
                    <?php
                    $obj = new AllDamageImmunityTypes;
                    $obj->saveDamageImmunityType($newType);
                    ?>
                    <p>Thank you, <?php echo $newType ?> has been added.</p>
                    <paper-button raised class="full-width-button link-out" data-src="/admin/builder/damage-type.php">Add Another Damage / Immunity Type</paper-button>
                </paper-material>
            </div>
        </paper-header-panel>
    </paper-drawer-panel>
