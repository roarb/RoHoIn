...
<head>
    ...
    <title>Saved New Weapon - RoHo.in Admin Panel</title>
</head>
...
<?php if($_SESSION['user_name'] ==  'roarb'): ?>
    <paper-drawer-panel>
        ...
        <paper-header-panel main>
            <paper-toolbar class="primary">
                <paper-icon-button icon="menu" paper-drawer-toggle></paper-icon-button>
                <h1 class="full-page-title">Saved New Weapon <?php echo $name ?></h1>
            ...
            <div class="info-block-tools cushion">
                <paper-material elevation="1" class="cushion">
                    <?php
                    $obj = new AllWeapons;
                    $obj->saveWeapon($name, $ranged, $range, $rof, $aoe, $pow, $reach, $damageType, $criticalEffect, $continuousEffect, $openFist, $magical, $specialAction1, $specialAction2, $specialAction3, $specialAction4, $weaponsMaster, $thrown, $buckler, $shield);
                    ...
                    ?>
                    <div class="center">
                        <paper-button class="md-raised md-primary md-mid link-out" data-src="/admin/builder/weapon.php">Add another Weapon</paper-button>
                    </div>
                </paper-material>
            </div>
        </paper-header-panel>
