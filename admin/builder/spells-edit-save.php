...
<head>
    ...
    <title>Updated Spell - RoHo.in Admin Panel</title>
</head>
...
<?php if($_SESSION['user_name'] ==  'roarb'): ?>
    <paper-drawer-panel>
        ...
        <paper-header-panel main>
            <paper-toolbar class="primary">
                <paper-icon-button icon="menu" paper-drawer-toggle></paper-icon-button>
                <h1 class="full-page-title">Updated Spell <?php echo $name ?></h1>
            ...
            <div class="info-block-tools cushion">
                <paper-material elevation="1" class="cushion">
                    <?php $obj = new AllSpellsKnown;
                    $obj->updateSpell($name, $description, $cost, $range, $aoe, $pow, $upkeep, $offensive, $specialAbility1, $specialAbility2, $offSpdMod, $offStrMod, $offMatMod, $offRatMod, $offDefMod, $offArmMod, $duration); ?>
                ...
                <div class="center">
                    <paper-button class="md-raised md-primary md-mid link-out" data-src="/admin/builder/spells.php">Back to Spells Menu</paper-button>
                </div>
            </div>
        </paper-header-panel>
    </paper-drawer-panel>
