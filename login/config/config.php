...
define("DB_NAME", "roho_warmahordes");
define("DB_USER", "whrob");
define("DB_PASS", "kachowLand2");
...
define("COOKIE_DOMAIN", "http://roho.in");
...
define("EMAIL_SMTP_HOST", "roho.in");
define("EMAIL_SMTP_AUTH", true);
define("EMAIL_SMTP_USERNAME", "admin@roho.in");
define("EMAIL_SMTP_PASSWORD", "Randomland42");
define("EMAIL_SMTP_PORT", 465);
define("EMAIL_SMTP_ENCRYPTION", "ssl");
 ...
 */
define("EMAIL_PASSWORDRESET_URL", "http://roho.in/login/password_reset.php");
define("EMAIL_PASSWORDRESET_FROM", "admin@roho.com");
define("EMAIL_PASSWORDRESET_FROM_NAME", "RoHo.in Password Reset");
define("EMAIL_PASSWORDRESET_SUBJECT", "Password reset for RoHo.in");
 ...
 */
define("EMAIL_VERIFICATION_URL", "http://roho.in/login/register.php");
define("EMAIL_VERIFICATION_FROM", "admin@roho.com");
define("EMAIL_VERIFICATION_FROM_NAME", "RoHo.in Email Verification");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for RoHo.in");
