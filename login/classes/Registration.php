    ...
    public function verifyNewUser($user_id, $user_activation_hash)
    {
        ...
        if ($this->databaseConnection()) {
            ...
            if ($query_update_user->rowCount() > 0) {
                ...
                // email Rob to let him know a new user was added
                mail('rhoehn24@gmail.com', 'New RoHo.In User Validated', 'A new user has signed up for RoHo.In, user_id='.$user_id);
            } else {
                $this->errors[] = MESSAGE_REGISTRATION_ACTIVATION_NOT_SUCCESSFUL;
                // email Rob to let him know a new user failed to validate
                mail('rhoehn24@gmail.com', 'New RoHo.In User Failed Validation', 'A new user has tried to sign up for RoHo.In, user_id='.$user_id);
            }
        }
    }
}
