...
<head>
    ...
    <title>Edit Your Account - RoHo.In</title>
</head>
...
<paper-drawer-panel>
    ...
    <paper-header-panel main>
        <paper-toolbar class="primary">
            <paper-icon-button icon="menu" paper-drawer-toggle></paper-icon-button>
            <h1 class="full-page-title">Edit Your Account</h1>
        </paper-toolbar>
        <div class="cushion info-block">
            <?php // ... ask if we are logged in here:
